...
CREATE TABLE `fraisforfait` (
  ...
  `ff_libelle` char(20) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `ff_montant` int DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `fraisforfait` VALUES ('KM','Frais Kilométrique',2),('NUI','Nuitée Hôtel',70),('REP','Repas Restaurant',25);
