...
CREATE TABLE `etat` (
  `id` int NOT NULL,
  `libelle` varchar(30) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `etat` VALUES (0,'Fiche créée, saisie en cours'),(1,'Saisie clôturée'),(2,'Validée et mise en paiement');
